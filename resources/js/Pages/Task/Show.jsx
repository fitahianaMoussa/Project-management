...
import {
  PRIORITY_CLASS_MAP, PRIORITY_TEXT_MAP,
              ...
              <div className="grid gap-1 grid-cols-2 mt-2">
                ...
                <div>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1">
                      <span className={"px-2 py-1 rounded text-white " + PRIORITY_CLASS_MAP[task.priority]}>{PRIORITY_TEXT_MAP[task.priority]}</span>
                    </p>
                  </div>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1">
                     <Link className="hover:underline" href={route('project.show',task.project_id)}>{task.project.name}</Link>
                    </p>
                  </div>
                  <div className="mt-4">
